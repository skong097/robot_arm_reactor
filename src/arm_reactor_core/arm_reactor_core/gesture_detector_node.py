...
모델: share/arm_reactor_core/models/gesture/gesture_recognizer.task (외부 부트스트랩).
"""
...
from arm_reactor_core.gesture_detection import WaveDetector, classify_hand_state
...
class GestureDetectorNode(Node):
    ...
    def __init__(self):
        ...
        if not model_path:
            model_path = str(
                Path(get_package_share_directory('arm_reactor_core'))
